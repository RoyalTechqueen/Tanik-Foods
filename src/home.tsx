           ...
           <nav className="hidden sm:flex space-x-8 text-md">
             ...
             <button className="px-2 py-1 bg-red-700 rounded-md">
               <a
                 ...
                 className="inline-flex items-center justify-center  text-base font-medium text-center text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900"
               >
                 Contact Us
               </a>
             </button>
       ...
       <section id="about" className="bg-white py-16">
         <div className="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8">
           ...
           <p className="mt-4 text-lg text-gray-500 text-center">
             ...
             for natural spices, seasonings, and healthy meals. Our mission is
             to promote a healthy lifestyle through high-quality, natural
             products.
           </p>
           <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
             <div>
               ...
               <p className="mt-2 text-gray-600">
                 ...
                 [2022], our journey has been driven by the desire to provide
                 the most natural spices and seasonings to our customers. Over
                 the years, we have expanded our offerings to include a variety
                 of healthy meals and pastry mixes, ensuring that every product
                 we offer meets our high standards of quality and taste.
               </p>
             </div>
             <div>
               ...
               <p className="mt-2 text-gray-600">
                 ...
                 we strive to inspire healthier eating habits with our wide
                 range of products. From natural spices and seasonings to
                 healthy meals and pastry mixes, we are dedicated to helping you
                 create delicious, wholesome meals that nourish your body and
               ...
               <div className="bg-white rounded-lg shadow-md">
                 ...
                 <div className="p-6">
                   ...
                   <div className="flex justify-center items-center">
                     <button
                       className="px-2 py-2 bg-red-700 rounded-md"
